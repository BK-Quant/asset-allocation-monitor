...
## 특징
- 25개 전략: 한국 ETF 정적배분 3종(안정/중립/성장), 영구포트폴리오, 듀얼모멘텀 3종(전통/종합/가속), LAA, RAA, GTAA, PAA, VAA, FAA, AAA, DAA(-G12), DGA, 채권동적배분, K-올웨더 v1, K-올웨더 v2 4종(MP/성장/중립/안정), 한미정적자산배분, 한미동적 2종(안정/공격)
